...
using Infogroup.IDMS.MultiTenancy.HostDashboard;
...
namespace Infogroup.IDMS.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private static void CreatePaidPayment(IDMSDbContext context, SubscriptionPayment subscriptionPayment)
        {

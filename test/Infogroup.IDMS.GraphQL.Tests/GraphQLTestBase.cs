...
namespace Infogroup.IDMS.GraphQL.Tests
{
    ...
    public class GraphQLTestBase<TSchema, TDocumentBuilder> : AppTestBase<IDMSGraphQLTestModule>
        where TSchema : ISchema
        where TDocumentBuilder : IDocumentBuilder, new()
    {
        ...
        public static ExecutionResult ParseQueryResult(string result, ExecutionErrors errors = null)
        {
            object data = null;

...
namespace Infogroup.IDMS.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!IDMSConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[] {
                ...
                new SettingDefinition(AppSettings.HostManagement.AllowOneConcurrentLoginPerUser, GetFromAppSettings(AppSettings.HostManagement.AllowOneConcurrentLoginPerUser, "false"), isVisibleToClients: true),
                new SettingDefinition(AppSettings.GoogleMaps.ApiKey, GetFromSettings("GoogleMaps:ApiKey"), isVisibleToClients: true),
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings, GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings, IDMSConsts.MultiTenancyEnabled? "true":"false"), scopes: SettingScopes.Tenant)
            };
        }

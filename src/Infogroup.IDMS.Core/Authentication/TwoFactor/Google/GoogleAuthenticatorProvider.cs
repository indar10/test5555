...
namespace Infogroup.IDMS.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : IDMSServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Infogroup.IDMS", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);

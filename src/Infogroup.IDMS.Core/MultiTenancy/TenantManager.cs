...
using Infogroup.IDMS.MultiTenancy.Demo;
...
namespace Infogroup.IDMS.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(IDMSConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");

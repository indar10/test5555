...
namespace Infogroup.IDMS.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : IDMSServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "IDMS";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + IDMSConsts.Currency;
        }

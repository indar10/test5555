...
using Infogroup.IDMS.Web.Configuration;

namespace Infogroup.IDMS.Web
{
    [DependsOn(
    ...
    public class IDMSWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public IDMSWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(IDMSApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IDMSWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            appFolders.WebLogsFolder = @"C:\Log";

#if NET461
            if (_env.IsDevelopment())
            {
                var currentAssemblyDirectoryPath = typeof(IDMSWebCoreModule).GetAssembly().GetDirectoryPathOrNull();

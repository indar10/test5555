...
namespace Infogroup.IDMS.Web.Authentication.JwtBearer
{
    public class IDMSJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public IDMSJwtSecurityTokenHandler()
        {
        ...
        {
            using (var securityStampHandler = IocManager.Instance.ResolveAsDisposable<IIDMSJwtSecurityStampHandler>())
            {

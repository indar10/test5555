...
using Infogroup.IDMS.Web.Public.Startup;
using Infogroup.IDMS.Web.Session;

namespace Infogroup.IDMS.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : IDMSViewComponent
    {

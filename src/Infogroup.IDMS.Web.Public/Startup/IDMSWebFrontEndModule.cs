...
namespace Infogroup.IDMS.Web.Public.Startup
{
    [DependsOn(
        typeof(IDMSWebCoreModule)
    )]
    public class IDMSWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public IDMSWebFrontEndModule(IHostingEnvironment env, IDMSEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IDMSWebFrontEndModule).GetAssembly());
        }
    }
}

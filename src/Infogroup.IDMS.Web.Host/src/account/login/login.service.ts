...
export class LoginService {
    ...
    private processAuthenticateResult(authenticateResult: AuthenticateResultModel, redirectUrl?: string) {
        ...
        if (authenticateResult.shouldResetPassword) {
            ...
            if (authenticateResult.lockWarning) {
                this._messageService.warn(authenticateResult.lockWarning).then(() => {
                    this.Redirect(authenticateResult, redirectUrl);
                });
            }
            else {
                this.Redirect(authenticateResult, redirectUrl);
    ...
    private Redirect(authenticateResult: AuthenticateResultModel, redirectUrl?: string) {

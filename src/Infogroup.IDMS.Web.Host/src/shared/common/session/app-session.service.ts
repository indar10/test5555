...
import { ApplicationInfoDto, GetCurrentLoginInformationsOutput, SessionServiceProxy, TenantLoginInfoDto, UserLoginInfoDto, UiCustomizationSettingsDto, IdmsUserLoginInfoDto } from '@shared/service-proxies/service-proxies';
...
export class AppSessionService {
    ...
    private _idmsUser: IdmsUserLoginInfoDto;
    ...
    get idmsUser(): IdmsUserLoginInfoDto {
        return this._idmsUser;
    }
    ...
    init(): Promise<UiCustomizationSettingsDto> {
        return new Promise<UiCustomizationSettingsDto>((resolve, reject) => {
            this._sessionService.getCurrentLoginInformations().toPromise().then((result: GetCurrentLoginInformationsOutput) => {
                ...
                this._idmsUser = result.idmsUser;

...
namespace Infogroup.IDMS
{
    ...
    public class AppConsts
    {
        ...
        public const string TblConfigurationCacheKey = "Configuration";
        public const string TblSICFranchiseCodeKey = "SICFranchiseCode";
        public const string TblIndustryCodeKey = "IndustryCode";
        public const string TblSICCodeRelatedKey = "SICCodeRelated";
        public const string TblSICCodeKey = "SICCode";
        public const string TblState = "State";
        public const string DefaultDatabaseId = "DDC";

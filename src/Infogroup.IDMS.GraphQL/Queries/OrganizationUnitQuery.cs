...
using Infogroup.IDMS.Core.Base;
using Infogroup.IDMS.Core.Extensions;
using Infogroup.IDMS.Dto;
using Infogroup.IDMS.Types;

namespace Infogroup.IDMS.Queries
{
    public class OrganizationUnitQuery : IDMSQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {

...
using Infogroup.IDMS.Auditing.Exporting;
using Infogroup.IDMS.Authorization;
using Infogroup.IDMS.Authorization.Users;
using Infogroup.IDMS.Dto;
using Infogroup.IDMS.EntityHistory;
using EntityHistoryHelper = Infogroup.IDMS.EntityHistory.EntityHistoryHelper;

namespace Infogroup.IDMS.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : IDMSAppServiceBase, IAuditLogAppService
    {

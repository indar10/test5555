...
namespace Infogroup.IDMS.Configuration.Host
{
    ...
    public class HostSettingsAppService : SettingsAppServiceBase, IHostSettingsAppService
    {
        ...
        {
            return await SettingManager.GetSettingValueAsync<bool>(AppSettings.HostManagement.AllowOneConcurrentLoginPerUser);
        }
        ...
        {
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.HostManagement.AllowOneConcurrentLoginPerUser, allowOneConcurrentLoginPerUser.ToString());
        }

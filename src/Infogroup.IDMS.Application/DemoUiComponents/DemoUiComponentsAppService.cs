...
using Infogroup.IDMS.DemoUiComponents.Dto;

namespace Infogroup.IDMS.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : IDMSAppServiceBase, IDemoUiComponentsAppService
    {

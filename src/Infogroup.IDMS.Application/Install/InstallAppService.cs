...
using Infogroup.IDMS.Migrations.Seed.Host;
...
namespace Infogroup.IDMS.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : IDMSAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<IDMSDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(IDMSConsts.ConnectionStringName).Value.ToString();
        }

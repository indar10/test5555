...
namespace Infogroup.IDMS.Authorization.Accounts
{
    public class AccountAppService : IDMSAppServiceBase, IAccountAppService
    {
        ...
        public async Task<ResetPasswordOutput> ResetPassword(ResetPasswordInput input)
        {
            ...
            _passwordManager.CheckRecentPasswords(user, input.Password);
